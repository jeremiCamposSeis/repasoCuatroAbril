    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="<?php echo base_url(); ?>logout" data-toggle="modal"  class="dropdown-item dropdown-footer"  data-target="#logoutModal">salir</a>
        </div>
      </li>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php foreach($rutas as $rutaP):
                if($rutaP->RUT_PADRE==0){
                    if($rutaP->RUT_RUTA=="-"){
            ?>     

                    <li class="nav-item">
                        <a href="<?php echo base_url().$rutaP->RUT_RUTA;?>" class="nav-link">
                        <i class="nav-icon fas fa-chart-pie"></i>
                        <p>
                            <?=esc($rutaP->RUT_NOMBRE) ?>
                            <i class="right fas fa-angle-left"></i>
                        </p>
                        </a>
                        <ul class="nav nav-treeview">
<?php 
                        foreach($rutas as $rutaH):
                            if($rutaH->RUT_PADRE==$rutaP->RUT_ID){
                                $dato=$rutaH->RUT_ID;
?>
                            <li class="nav-item">
                                <a href="<?php echo base_url().$rutaH->RUT_RUTA.'/'.$dato;?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?=esc($rutaH->RUT_NOMBRE) ?>
                                </p>
                                </a>
                            </li>
 <?php 
